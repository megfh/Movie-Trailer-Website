...
monster_in_law = media.Movie("Monster in Law",
                             "https://upload.wikimedia.org/wikipedia/en/d/d5/Monster-in-Law_poster.JPG",  # NOQA
...
quartet = media.Movie("Quartet",
                      "https://upload.wikimedia.org/wikipedia/en/1/1d/Quartet-Poster.jpg",  # NOQA
                      "https://www.youtube.com/watch?v=wSEnh8Hi62E")

# create a list containing all of the instances created above
movies = [youve_got_mail, good_will_hunting, monster_in_law, imitation_game,
          aristocats, quartet]

# use the open_movies_page function from fresh_tomatoes to
# create an HTML file to display the page
